    ...
    <section className="h-screen pt-16 px-9 grid place-content-center place-items-center">
        ...
        <section className="max-w-lg">
          <p className="text-justify mb-5">
            ...
            I am currently a 3rd year undergrad studying at AMA Computer College  and an intern at 
            <a href="http://poblacion.ph/" className="text-emerald-500"> Poblacion.ph</a> which is a startup Ecommerce company.
          </p>
